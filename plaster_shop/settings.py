"""
Django settings for plaster_shop project.
...
ROOT_URLCONF = 'plaster_shop.urls'
...
WSGI_APPLICATION = 'plaster_shop.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / "static"]  # если используете разработку
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')   # для продакшена (при collectstatic)

# Настройки WhiteNoise для сжатия и "вечного кэширования"
